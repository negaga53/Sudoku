...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      // Multiplayer
      'online2Players': 'Online 2 Players',
      'regularBattle': 'Regular Battle',
      'regularBattleDesc': 'Race to solve the puzzle first',
      'createGame': 'Create Game',
      'createGameDesc': 'Host a game and wait for an opponent',
      ...
      'youWin': 'You Win!',
      'youLost': 'You Lost',
      'opponentLeftGame': 'Your opponent left the game',
      'youFinishedFirst': 'You finished the puzzle first!',
      'opponentFinishedFirst': 'Your opponent finished first',
    ...
    'fr': {
      ...
      // Multiplayer
      'online2Players': 'En Ligne 2 Joueurs',
      'regularBattle': 'Bataille Classique',
      'regularBattleDesc': 'Course pour résoudre le puzzle en premier',
      'createGame': 'Créer une Partie',
      'createGameDesc': 'Hébergez une partie et attendez un adversaire',
      ...
      'modeLabel': 'Mode : ',
      'createAndWait': 'Créer & Attendre',
      'youWin': 'Vous avez gagné !',
      'youLost': 'Vous avez perdu',
      'opponentLeftGame': 'Votre adversaire a quitté la partie',
      'youFinishedFirst': 'Vous avez terminé le puzzle en premier !',
      'opponentFinishedFirst': 'Votre adversaire a terminé en premier',
